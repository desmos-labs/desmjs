...
function createBaseGenesisState(): GenesisState {
  return { subspacesData: [], registeredReactions: [], postsData: [], reactions: [], subspacesParams: [] };
}
...
export const GenesisState = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          break;
        case 5:
          message.subspacesParams.push(SubspaceReactionsParams.decode(reader, reader.uint32()));
          break;
        default:
  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      subspacesParams: Array.isArray(object?.subspacesParams)
        ? object.subspacesParams.map((e: any) => SubspaceReactionsParams.fromJSON(e))
        : [],
    };
  },
  ...
  toJSON(message: GenesisState): unknown {
    ...
    if (message.subspacesParams) {
      obj.subspacesParams = message.subspacesParams.map((e) => e ? SubspaceReactionsParams.toJSON(e) : undefined);
    } else {
      obj.subspacesParams = [];
    }
    return obj;
  ...
  fromPartial<I extends Exact<DeepPartial<GenesisState>, I>>(object: I): GenesisState {
    ...
    message.subspacesParams = object.subspacesParams?.map((e) => SubspaceReactionsParams.fromPartial(e)) || [];
    return message;
  },
};
