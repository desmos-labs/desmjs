...
import { Section, Subspace, UserGroup, UserPermission } from "./models";
...
export const GenesisState = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.subspacesData.push(SubspaceData.decode(reader, reader.uint32()));
          break;
        case 3:
        ...
        case 4:
          ...
          break;
        case 5:
          message.userPermissions.push(UserPermission.decode(reader, reader.uint32()));
          break;
        case 6:
          message.userGroups.push(UserGroup.decode(reader, reader.uint32()));
          break;
        case 7:
          message.userGroupsMembers.push(UserGroupMemberEntry.decode(reader, reader.uint32()));
          break;
        default:
  ...
  fromJSON(object: any): GenesisState {
    return {
      initialSubspaceId: isSet(object.initialSubspaceId) ? Long.fromValue(object.initialSubspaceId) : Long.UZERO,
      ...
      userGroupsMembers: Array.isArray(object?.userGroupsMembers)
        ? object.userGroupsMembers.map((e: any) => UserGroupMemberEntry.fromJSON(e))
        : [],
    };
  },
  ...
  toJSON(message: GenesisState): unknown {
    ...
    message.initialSubspaceId !== undefined &&
      (obj.initialSubspaceId = (message.initialSubspaceId || Long.UZERO).toString());
    if (message.subspacesData) {
      obj.subspacesData = message.subspacesData.map((e) => e ? SubspaceData.toJSON(e) : undefined);
    } else {
      obj.subspacesData = [];
    }
    ...
    if (message.userPermissions) {
      obj.userPermissions = message.userPermissions.map((e) => e ? UserPermission.toJSON(e) : undefined);
    } else {
      obj.userPermissions = [];
    }
    ...
    if (message.userGroupsMembers) {
      obj.userGroupsMembers = message.userGroupsMembers.map((e) => e ? UserGroupMemberEntry.toJSON(e) : undefined);
    } else {
  ...
  fromPartial<I extends Exact<DeepPartial<GenesisState>, I>>(object: I): GenesisState {
    const message = createBaseGenesisState();
    message.initialSubspaceId = (object.initialSubspaceId !== undefined && object.initialSubspaceId !== null)
      ? Long.fromValue(object.initialSubspaceId)
      : Long.UZERO;
    message.subspacesData = object.subspacesData?.map((e) => SubspaceData.fromPartial(e)) || [];
    ...
    message.userPermissions = object.userPermissions?.map((e) => UserPermission.fromPartial(e)) || [];
    message.userGroups = object.userGroups?.map((e) => UserGroup.fromPartial(e)) || [];
    message.userGroupsMembers = object.userGroupsMembers?.map((e) => UserGroupMemberEntry.fromPartial(e)) || [];
    return message;
  },
};
...
export const SubspaceData = {
  encode(message: SubspaceData, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  fromJSON(object: any): SubspaceData {
    return {
      ...
      nextSectionId: isSet(object.nextSectionId) ? Number(object.nextSectionId) : 0,
    };
  },
  ...
  toJSON(message: SubspaceData): unknown {
    ...
    message.nextGroupId !== undefined && (obj.nextGroupId = Math.round(message.nextGroupId));
    message.nextSectionId !== undefined && (obj.nextSectionId = Math.round(message.nextSectionId));
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<SubspaceData>, I>>(object: I): SubspaceData {
    const message = createBaseSubspaceData();
...
export const UserGroupMemberEntry = {
  encode(message: UserGroupMemberEntry, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (!message.subspaceId.isZero()) {
      writer.uint32(8).uint64(message.subspaceId);
    }
  ...
  fromPartial<I extends Exact<DeepPartial<UserGroupMemberEntry>, I>>(object: I): UserGroupMemberEntry {
    const message = createBaseUserGroupMemberEntry();
    message.subspaceId = (object.subspaceId !== undefined && object.subspaceId !== null)
      ? Long.fromValue(object.subspaceId)
      : Long.UZERO;
