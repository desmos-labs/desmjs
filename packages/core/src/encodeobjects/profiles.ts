...
import {MsgLinkApplication, MsgUnlinkApplication} from "@desmoslabs/desmjs-types/desmos/profiles/v1beta1/msgs_app_links";
import {MsgLinkChainAccount, MsgUnlinkChainAccount} from "@desmoslabs/desmjs-types/desmos/profiles/v1beta1/msgs_chain_links";
import {MsgAcceptDTagTransferRequest, MsgCancelDTagTransferRequest, MsgRefuseDTagTransferRequest, MsgRequestDTagTransfer} from "@desmoslabs/desmjs-types/desmos/profiles/v1beta1/msgs_dtag_requests";
import {MsgDeleteProfile, MsgSaveProfile} from "@desmoslabs/desmjs-types/desmos/profiles/v1beta1/msgs_profile";
import {MsgBlockUser, MsgCreateRelationship, MsgDeleteRelationship, MsgUnblockUser} from "@desmoslabs/desmjs-types/desmos/profiles/v1beta1/msgs_relationships";
