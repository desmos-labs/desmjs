...
function createBaseQueryReportsRequest(): QueryReportsRequest {
  return { subspaceId: Long.UZERO, target: undefined, reporter: "", pagination: undefined };
}

export const QueryReportsRequest = {
  encode(message: QueryReportsRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryReportsRequest>, I>>(object: I): QueryReportsRequest {
    const message = createBaseQueryReportsRequest();
...
export const QueryReportsResponse = {
  encode(message: QueryReportsResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryReportsResponse>, I>>(object: I): QueryReportsResponse {
    const message = createBaseQueryReportsResponse();
...
function createBaseQueryReportRequest(): QueryReportRequest {
  return { subspaceId: Long.UZERO, reportId: Long.UZERO };
}

export const QueryReportRequest = {
  encode(message: QueryReportRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (!message.subspaceId.isZero()) {
      writer.uint32(8).uint64(message.subspaceId);
    }
  ...
  fromPartial<I extends Exact<DeepPartial<QueryReportRequest>, I>>(object: I): QueryReportRequest {
    const message = createBaseQueryReportRequest();
    message.subspaceId = (object.subspaceId !== undefined && object.subspaceId !== null)
      ? Long.fromValue(object.subspaceId)
      : Long.UZERO;
...
export const QueryReasonsRequest = {
  encode(message: QueryReasonsRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (!message.subspaceId.isZero()) {
      writer.uint32(8).uint64(message.subspaceId);
    }
    if (message.pagination !== undefined) {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryReasonsRequest>, I>>(object: I): QueryReasonsRequest {
    const message = createBaseQueryReasonsRequest();
    message.subspaceId = (object.subspaceId !== undefined && object.subspaceId !== null)
      ? Long.fromValue(object.subspaceId)
      : Long.UZERO;
...
function createBaseQueryReasonsResponse(): QueryReasonsResponse {
  return { reasons: [], pagination: undefined };
}

export const QueryReasonsResponse = {
  encode(message: QueryReasonsResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryReasonsResponse>, I>>(object: I): QueryReasonsResponse {
    const message = createBaseQueryReasonsResponse();
...
function createBaseQueryReasonRequest(): QueryReasonRequest {
  return { subspaceId: Long.UZERO, reasonId: 0 };
}

export const QueryReasonRequest = {
  encode(message: QueryReasonRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (!message.subspaceId.isZero()) {
      writer.uint32(8).uint64(message.subspaceId);
    }
  ...
  fromPartial<I extends Exact<DeepPartial<QueryReasonRequest>, I>>(object: I): QueryReasonRequest {
    const message = createBaseQueryReasonRequest();
    message.subspaceId = (object.subspaceId !== undefined && object.subspaceId !== null)
      ? Long.fromValue(object.subspaceId)
      : Long.UZERO;
...
export const QueryReasonResponse = {
  encode(message: QueryReasonResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  fromJSON(object: any): QueryReasonResponse {
    return { reason: isSet(object.reason) ? Reason.fromJSON(object.reason) : undefined };
  },

  toJSON(message: QueryReasonResponse): unknown {
    const obj: any = {};
    message.reason !== undefined && (obj.reason = message.reason ? Reason.toJSON(message.reason) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<QueryReasonResponse>, I>>(object: I): QueryReasonResponse {
    const message = createBaseQueryReasonResponse();
...
export class QueryClientImpl implements Query {
  ...
  constructor(rpc: Rpc, opts?: { service?: string }) {
    this.service = opts?.service || "desmos.reports.v1.Query";
    this.rpc = rpc;
  ...
  Reports(request: QueryReportsRequest): Promise<QueryReportsResponse> {
    ...
    const promise = this.rpc.request(this.service, "Reports", data);
    return promise.then((data) => QueryReportsResponse.decode(new _m0.Reader(data)));
  }

  Report(request: QueryReportRequest): Promise<QueryReportResponse> {
    const data = QueryReportRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "Report", data);
    return promise.then((data) => QueryReportResponse.decode(new _m0.Reader(data)));
  }

  Reasons(request: QueryReasonsRequest): Promise<QueryReasonsResponse> {
    const data = QueryReasonsRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "Reasons", data);
    return promise.then((data) => QueryReasonsResponse.decode(new _m0.Reader(data)));
  }

  Reason(request: QueryReasonRequest): Promise<QueryReasonResponse> {
    const data = QueryReasonRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "Reason", data);
    return promise.then((data) => QueryReasonResponse.decode(new _m0.Reader(data)));
  }
